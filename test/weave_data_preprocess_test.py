...
class WeaveTestCase(unittest.TestCase):
    ...
    def setUp(self):
        self.number_df = pd.read_csv('data/number_data/VIEW_TEXTILE_NUMBER_DATA(2)_1.csv')
        self.string_df = pd.read_csv('data/string_data/VIEW_TEXTILE_STRING_DATA(2)_1.csv')
